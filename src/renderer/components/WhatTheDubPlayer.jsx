...
export default (props) => {
    ...
    if (props.width) {
        return (
            <div style={{position: "relative", background: "black", color: "white"}} className="video-window">
                <div style={{position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)"}}>{loading ? "Loading Video..." : null}</div>
                {props.videoSource ?
                    <video
                        id="videoElement"
                        ref={videoElement}
